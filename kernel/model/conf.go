...
type AppConf struct {
	...
	CommunityVersion bool             `json:"communityVersion"`
}
...
func InitConf() {
	...
	Conf.CommunityVersion = true
	logging.LogInfof("foss community version")
...
func IsSubscriber() bool {
	return nil != Conf.User && (-1 == Conf.User.UserSiYuanProExpireTime || 0 < Conf.User.UserSiYuanProExpireTime) && 0 == Conf.User.UserSiYuanSubscriptionStatus || Conf.CommunityVersion
}

func IsThirdPartySyncPaid() bool {
	return IsSubscriber() || Conf.CommunityVersion || nil != Conf.User
	if IsSubscriber() {
		return true
	}
